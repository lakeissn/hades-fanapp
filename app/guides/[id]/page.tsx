    ...
    items: [
      {
        ...
        hasDeviceImages: true,
        images: [],
        pcImages: ["/guides/images/present_mobile.jpg],
        mobileImages: ["/guides/images/present_pc.jpg"],
      },
    ],
  },
  download: {
    ...
    items: [
      {
        ...
        hasDeviceImages: true,
        images: [],
        pcImages: ["/guides/images/download_mobile.jpg"],
        mobileImages: ["/guides/images/download_pc.jpg"],
      },
    ],
  },
  vote: {
