...
import MelonPlaylist from "./MelonPlaylist";
...
export default function HomePageClient({ initialMembers, initialVotes }: { initialMembers: MemberStatus[]; initialVotes: VoteItem[] }) {
